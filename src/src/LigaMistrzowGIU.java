...
public class LigaMistrzowGIU extends JFrame {
    ...
    public LigaMistrzowGIU(Team t1[], ArrayList<Formation> f) {
    ...
    public void setTeamList(Team t1[]){
        ...
        jComboBox1.setModel(new DefaultComboBoxModel<>(TeamList));
        jComboBox2.setModel(new DefaultComboBoxModel<>(TeamList));
    }
                ...
                layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(jButton1, GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE))
                                .addGap(144, 144, 144))
                        .addGroup(layout.createSequentialGroup()
                                .addGap(131, 131, 131)
                                .addComponent(jComboBox1, GroupLayout.PREFERRED_SIZE, 129, GroupLayout.PREFERRED_SIZE)
    ...
    private void  jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        LigaMistrzowGIU2 window2= new LigaMistrzowGIU2(findTeam2(teams[(jComboBox1.getSelectedIndex())].getName()),findTeam2(teams[(jComboBox2.getSelectedIndex())].getName()),formations);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LigaMistrzowGIU.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        /* Utworzenie i wysylanie formularza */
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LigaMistrzowGIU(ChampionsLeagueCompetitors,formations).setVisible(true);
            }
        });
    }
